#+TITLE:Magit
#+OPTIONS: toc:nil
#+SETUPFILE: /Users/stone20091652/org/html/setup/theme-bigblow.setup
* 什么是 Magit
...
3. 输入 c,跳出一些选项，再输入 c。
4. 这里是你输入 Commit 的理由的地方，我们输入 Frist commit
5. 输入完后，c-c c-c 运行
6. 在 Unpushed 这行输入 P(大写）,这里选择 p 的选项，意思是 Push master to 你的库p
